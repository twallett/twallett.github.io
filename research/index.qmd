...
for card in cards:
    card_html = f'''
    <div id="{card.get('id', card['title'].lower().replace(' ', '-'))}" class="card-container" style="display: flex; align-items: center; flex-wrap: wrap; padding: 1rem; border: 1px solid #ccc; border-radius: 10px; box-shadow: 2px 2px 8px rgba(0,0,0,0.1);">
